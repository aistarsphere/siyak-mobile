...
class ContextGameApi {
  ...
  Future<ModesInfo> modes(String language) async =>
      ModesInfo.fromJson(
  ...
  Future<GameSnapshot> newGame({
    ...
    String? mode,
      ...
      GameSnapshot.fromJson(await _client.postJson('/new-game', body: {
        'language': language,
        'category': category,
        'mode': ?mode,
      }));
  ...
  Future<GuessResponse> guess({
    ...
    required String guess,
      ...
      GuessResponse.fromJson(await _client.postJson('/guess', body: {
        'game_id': gameId,
        'guess': guess,
      }));
  ...
  Future<HintResult> hint({
    ...
    String? difficulty,
      ...
      HintResult.fromJson(await _client.postJson('/hint', body: {
        'game_id': gameId,
  ...
  Future<WordSuggestions> suggest({
    ...
    int limit = 8,
      ...
      WordSuggestions.fromJson(await _client.getJson('/suggest', query: {
        'language': language,
        'q': q,
        'limit': limit,
        'category': ?category,
